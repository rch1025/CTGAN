...
from ctgan.data_transformer import DataTransformer # CDF 기반이 아닌 MSN 기반
# from ctgan.data_transformer_cdf_new2 import DataTransformer
...
class CTGAN(BaseSynthesizer):
    ...
    def sample(self, n, condition_column=None, condition_value=None):
        ...
        data = data[:n]
        print('### Inverse start')
        return self._transformer.inverse_transform(data) # 오리지널 비교를 할 때는 Parallel 없음
